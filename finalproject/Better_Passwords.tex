...
Test subjects choose a memorable phrase and make an acronym of the first letter of each word. Every initial is lower-case in the password. They also choose a particular number and incorporate after the initials of the memorable phrase. For example, I might choose the hook from a famous Rolling Stones song (\textbf{I} \textbf{c}an't \textbf{g}et \textbf{n}o \textbf{s}atisfaction, and the month and year of my graduation from college (May, 2012) to generate the following password: icgns0512. 
